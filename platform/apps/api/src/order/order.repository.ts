...
export class OrderRepository {
  ...
  getOrderByIdForCustomer(
    ...
    return this.orders.find(
      (o) => o.tenantId === tenantId && o.id === orderId && o.customerId === customerId
    );
  }
  ...
  listOrdersForTenant(
    ...
    if (filters?.fulfillmentMode) {
      results = results.filter((o) => o.fulfillmentMode === filters.fulfillmentMode);
    }
    if (filters?.search) {
  ...
  listOrdersForCustomer(tenantId: string, customerId: string): OrderRecord[] {
    return this.orders
  ...
  countOrdersByStatus(tenantId: string): Map<OrderStatus, number> {
