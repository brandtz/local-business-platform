 ...
 */
export function buildPipelineView(pipeline: OrderPipelineCounts): PipelineStatusEntry[] {
 ...
 */
export function buildOrderListRow(order: AdminOrderSummary, now?: number): OrderListRowViewModel {
  return {
    id: order.id,
...
export function buildOrderDetailViewModel(
  ...
  return {
    ...
    deliveryAddress: detail.deliveryAddress ? formatAddress(detail.deliveryAddress) : null,
