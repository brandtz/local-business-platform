      ...
      ...(homeRouteAccess === "allow"
        ? {
            ...
            component: createPage(
              "Admin Shell",
              `${runtimeConfig.appTitle} is ready for tenant-scoped operational workflows. Auth state: ${describeAuthViewerState(authViewerState)}.${impersonationIndicator ? ` ${impersonationIndicator}` : ""}`
            )
          }
        : {
