...
const AUTH_VIEWER_STATE_OVERRIDE_KEY = "__platform_test_web_customer_auth_viewer__";

export function getAuthViewerState(): AuthViewerState {
  return readAuthViewerStateOverride() || createAnonymousAuthViewerState("customer");
}
