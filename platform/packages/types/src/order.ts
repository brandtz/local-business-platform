 ...
 */
export const terminalOrderStatuses: readonly OrderStatus[] = ["completed", "cancelled"];
 ...
 */
export function isValidOrderFulfillmentMode(mode: string): mode is OrderFulfillmentMode {
...
export function computeTrackingSteps(
  ...
  const statusIndex = isCancelled ? -1 : orderTrackingSteps.indexOf(status as OrderTrackingStep);
